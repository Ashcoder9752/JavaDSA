...
public class IntersectionOfTwoLinkedLists {
    ...
    // in case of not intersecting
    // both the pointers will have travelled m+n nodes

    // in case of intersecting
    // let x be the distance of linked list a from head to the connecting node
    // let y be the distance of linked list b from head to the connecting node
    // let c be the connected distance
    // both the pointers will have travelled x+y+c nodes


    // return the point when equal
    // either null or intersectingNode
    ...
    public static void main(String[] args) {
        ...
        list1.addLast(1);
        list1.addLast(2);
        Node connectingNode = list1.tail;
        list1.addLast(4);

        MyLinkedList list2 = new MyLinkedList();
        list2.addLast(3);
        list2.tail.next = connectingNode;

        Node intersectingNode = findIntersection(list1.head, list2.head);
